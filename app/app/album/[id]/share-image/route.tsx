...
import { getShareAlbumData, getSuppliedPaletteShareAlbumData, resolvePaletteShareAlbumData } from '@/lib/shareImageData';
...
export async function GET(
  ...
  const suppliedAlbum = isPaletteArtwork
    ...
    : null;
  const album = isPaletteArtwork
    ? await resolvePaletteShareAlbumData(id, country, suppliedAlbum)
    : await getShareAlbumData(id, country);
